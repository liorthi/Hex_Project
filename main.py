...
from player import RandomAI, HumanPlayer, GreedyAI
...
def main():
    ...
    #DatabaseHandler.save_board_database(board_database, filename=f"board_database_{number_of_games}_games_greedy.json")
